...
//namespace util
//{
//	void load_mesh(const std::filesystem::path& filePath,
//		std::vector<render::Mesh>& outMeshes,
//		std::vector<render::Material>& outMaterials) 
//	{
//
...
//			}
//
//			outMeshes.emplace_back(vertices, indices, entries, outMaterials);
//		}
//	}
//}
