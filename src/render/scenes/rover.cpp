...
void RoverRender::init()
{
	modelPath = "res/models/rover/rover.obj";
	...
	// light
	{
		std::shared_ptr<DirectionalLight> directionalLight = std::make_shared<DirectionalLight>(glm::vec3(0.5f, 1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f), 8.0f);
...
void RoverRender::preprocess()
{
	// skybox
	m_skyBox.initData(std::vector<std::filesystem::path>{
			"res/textures/skybox/desert/px.png",
			"res/textures/skybox/desert/nx.png",
			"res/textures/skybox/desert/py.png",
			"res/textures/skybox/desert/ny.png",
			"res/textures/skybox/desert/pz.png",
			"res/textures/skybox/desert/nz.png"
	});
...
void RoverRender::draw(glm::vec2 renderSize)
{
	DeferredRenderer::draw(renderSize);
}

void RoverRender::lightingPass()
{
	// bind framebuffer
